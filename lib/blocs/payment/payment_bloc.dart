...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  Future<Map<String, dynamic>> _callPayEndpointMethodId({
    ...
    final url = Uri.parse(
      'https://us-central1-ti-bazar-974.cloudfunctions.net/StripePayEndpointMethodId',
    );
  ...
  Future<Map<String, dynamic>> _callPayEndpointIntentId({
    ...
    final url = Uri.parse(
      'https://us-central1-ti-bazar-974.cloudfunctions.net/StripePayEndpointIntentId',
    );
    final response = await http.post(
      url,
      headers: {'Content-Type': 'application/json'},
